  ...
  render() {
    return (
      <section className="legal">
        ...
        <p>
          BY USING THE PRODUCT AND/OR BY CLICKING ON THE “I ACCEPT” LINK, YOU ARE CONSENTING TO BE BOUND BY ALL OF THE TERMS AND CONDITIONS SET FORTH BELOW.  IF YOU DO NOT AGREE TO BE BOUND BY ALL OF THE TERMS AND CONDITIONS SET FORTH BELOW, YOU ARE NOT PERMITTED TO USE THE PRODUCT, AND SHOULD RETURN THE PRODUCT TO VOLTERA.
        </p>
        <h2>Terms and Conditions.</h2>
        <h3>1.	Product Ownership and Usage. </h3>
        <p>The Voltera product is a prototyping tool for electronics, that is designed, developed and manufactured by Voltera, and consists of a printer that is designed to dispense conductive ink and solder paste onto FR4 (being a specific composite material composed of woven fiberglass cloth with an epoxy resin binder) to create circuit boards (the “Printer”), firmware included in such printer (“Firmware”), and software that runs the printer, to be installed on computers with supported operating systems (the “Software”).  The Printer, Firmware and Software are collectively referred to herein as the “Product”.  Where you have purchased the Product from Voltera, the conditions of sale under which you purchased the Product from Voltera shall apply to your purchase.  The following provisions apply to your possession and use of the Product:</p>
        <ol type="a">
          <li>
            Title to any Product bought by you shall pass to you upon your full payment for such Product; <strong>however, notwithstanding the foregoing, title to Firmware and Software shall NOT pass to you, and you are hereby put on notice that your use of the Firmware and Software supplied to you as part of or in conjunction with the Product is governed by and subject to the software license terms as set forth herein.</strong>  Use of any third party software under this Agreement shall be governed by and subject to your agreeing to the terms of all applicable third party agreements and licenses respecting such third party software.
          </li>
          <li>
          ...
          <li>
            Except to the extent expressly set forth herein or agreed upon in writing by you and Voltera, you shall not use the Product except for your personal use (which, in the case of a company, shall include use for your internal business functions), which shall not be for the purposes of development for commercial resale or further distribution of the Product, including without limitation by resale or sublicensing.
          </li>
          <li>
            Your use of the Product must be in accordance with the safety and usage instructions provided to you by Voltera in conjunction with the Product.  Without limiting the foregoing, you specifically acknowledge that:
          </li>
          <ol type="i">
            <li>
              The Printer has a heated platform that reaches temperatures as high as 240C in normal operation, and you must therefore follow all directions for placing and removing material from such platform; and
            </li>
            <li>
              The Printer must only be used in conjunction with the types of ink and printable materials specified for use with the Printer, and you must handle such ink and materials in accordance with their safety requirements (for example, as the ink is a mildly toxic household chemical, contact with eyes and mouth should be avoided).
            </li>
          </ol>
          <li>
          ...
          <ol type="i" start="3">
            <li>
              Copy, reproduce, modify, enhance, improve, alter, reverse engineer, disassemble, deconstruct, translate, decrypt, reverse compile or convert into human readable form the Product or any part thereof;
            </li>
            <li>
              distribute, assign, license, sublicense, lease, rent, transfer, sell or otherwise provide access to the Product, in whole or in part, to any third party, unless the Product is sold in its entirety to a third party who has agreed in writing to comply with the terms of this Agreement;
            </li>
            <li>
              remove, deface, cover or otherwise obscure any proprietary rights notice or identification on the Product (including without limitation any safety or copyright notice);
            </li>
            <li>
              copy any written or electronic materials accompanying any portion of the Product unless specifically authorized in writing to do so by Voltera; or
            </li>
            <li>
              authorize, permit or otherwise acquiesce in any other party engaging in the activities set forth in (i), (ii) (iii) or (iv) above, or attempting to do so.
            </li>
          </ol>
        </ol>
        <h3>2.	Product Changes.</h3>
        <p>
          Voltera reserves the right to make changes in the design of the Product (or any other of its products or services) without the obligation to make equivalent changes to Products that have previously been supplied to you.
        </p>

        <h3>3.	Software and Firmware License.</h3>
        <ol type="a">
          <li>
            Voltera hereby grants to you a personal, non-exclusive, non-transferable, royalty free license to use the Software in accordance with the terms of this Agreement and solely as specified in Section 1.  Except as expressly specified in this Agreement, this license does not imply any rights to future upgrades or updates to either the Software or Firmware.  However, if Voltera provides you with any upgrades or updates, such updates or upgrades shall be subject to the terms and conditions of this Agreement, and may be subject to additional payments.  Notwithstanding the foregoing, Voltera reserves the right, but has no obligation, to automatically download updates free of charge to Firmware and/or Software to maintain Product compatibility and to provide you with the latest supported version of the Firmware and/or Software.  In the event that you do not wish to obtain such automatic updates, you may notify Voltera at any time; however, discontinuance of such automatic updates may result in lack of Product support or additional charges for Product support due to your version being obsolete.  You do not have the right to obtain or use any source code for any Software.
          </li>
          <li>
            All installation of Software shall be solely your responsibility, at your own risk, and Voltera shall have no responsibility whatsoever to support such installation process.  The warranty in this Agreement shall not apply to any issues with the software arising from such installation of the software by you or any third party on your behalf. You are solely responsible for the selection, implementation, installation, maintenance and performance of any and all equipment, software and services used for accessing and using the software, including without limitation your internal network infrastructure and Internet service provider.  You are further responsible for ensuring that all such equipment, software and services meet Voltera’s reasonable requirements, as identified in the applicable Product documentation.
          </li>
          <li>
            In addition to the obligations set forth in Section 1, you shall not:
          </li>
          <ol type="i">
            <li>
              Attempt to hack the Software or any communication initiated by the Software or to defeat or overcome any encryption and/or other technical protection methods implemented by Voltera with respect to the Software;
            </li>
            <li>
        ...
        <ol type="a">
          <li>
            You must follow Voltera’s return policy, as posted on Voltera’s website or as otherwise provided to you, and obtain a valid, written Return Materials Authorization (RMA) from Voltera as part of the warranty return process. Voltera reserves the right to refuse or return any Product sent back without an RMA.
          </li>
          <li>
            If you notify Voltera of any such material defects or non-conformance within such one (1) year period and obtain the applicable RMA, Voltera will, at its option, repair or replace the Product. If Voltera is unable to repair or replace such Product within a reasonable timeframe, Voltera will refund you the amounts paid for such defective or non-conforming Product. All shipment of such Product is at your expense, unless Voltera otherwise agrees in writing.
          </li>
          <li>
          ...
          <li>
            <strong>The above warranty shall not apply to defects or non-conformities resulting from: (a) use of the Product in a manner contrary to, or not in accordance with, the documentation (including this Agreement), guidelines or instructions provided by Voltera, (b) any modification, maintenance or repair of the Product by anyone other than Voltera, (c) normal wear and tear, (d) external causes such as, but not limited to, power failure or electrical power surges, or (e) your breach of this Agreement. This warranty additionally does not cover Product marked as "sample" or sold "AS IS".</strong>
          </li>
          <li>
            Voltera does not warrant that the operation of the Product will be uninterrupted or error-free. Additionally, the foregoing warranty does not apply to any Software or Firmware provided to you; all Voltera Software and Firmware is provided “AS IS”, and subject only to the license terms applicable to such Software or Firmware.
