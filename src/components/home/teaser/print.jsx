    ...
    return (
      <div className='flex-row'>
        <div className={styles.videoWrap}>
          <YouTube videoId='mOzt_sbODZg' fluid={this.props.data.file.childImageSharp.fluid} width='600' />
        </div>
        <div className={styles.description}>
          ...
          <p>
            Create <strong>two layer circuit boards</strong> on your desk. Load your Gerber files and watch the
            dispenser lay down a <strong>silver-based conductive ink</strong> to print your circuit right before your
            eyes.
          </p>
