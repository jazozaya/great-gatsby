  ...
  renderBurnishingPad() {
    return (
      <div>
        ...
        <p>
          After your circuit is printed and cured, the silver traces need a quick burnishing step to remove any organic
          matter left behind. The burnishing pad contains micro­pores that can remove even the smallest contaminants.
        </p>
  ...
  renderNozzles() {
    return (
      <div>
        ...
        <p>
          With an inner diameter of ~230 microns (9 mil), these stainless steel dispensing tips are crucial for accurate
          deposition of ink and solder paste. Do you want ultra fine resolution? Visit our store for even smaller
          nozzles.
        </p>
        <p>
          They are installed directly on the cartridges and should be treated with care. The V-One ships with 2 extra
          nozzles in case you need them.
        </p>
  ...
  renderSolderWire() {
    return (
      <div>
        <h2>Solder Wire</h2>
        <p>
          Done printing? Let’s add some components! If you are working with through hole components, use this solder
          wire and plenty of flux to ensure a strong solder joint. We’ve chemically tested it to be most compatible with
          our nanoparticle ink.
        </p>
  ...
  renderSubstrates() {
    return (
      <div>
        <h2>Substrates</h2>
        <p>
          Every circuit needs a place to live. Once your design is finished, export the Gerbers and mount your substrate
          on the V-One to start printing.
        </p>
        <p>
          These substrates are standard FR4 boards coated with solder mask to make hand soldering and reflowing easier.
          We have several sizes to suit your needs, visit our store to see them all!
        </p>
  ...
  renderDispenser() {
    return (
      <div>
        <h2>Dispensers</h2>
        <p>
          This dispensing head is used to deposit ink or solder paste onto your board. An internal leadscrew is the key
          for extremely fine control over the ink flow.
        </p>
        <p>
          Installing them on the machine is a snap. Literally! The finger grips and magnets allow for seamless mounting
          and removal. No tools required.
        </p>
  ...
  renderCartridgeInk() {
    return (
      <div>
        ...
        <p>
          This ink cartridge is over 90% pure silver and can print up to 85 simple boards. That means 85 unique designs
          with no lead time.
        </p>
  ...
  renderCartridgePaste() {
    return (
      <div>
        ...
        <p>
          Whether you got the circuit boards from a factory or you made them with the V-One, this lead free solder paste
          cartridge will make board assembly a breeze.
        </p>
        <p>
          A single cartridge is able to populate over 10,000 0603 pads, that is more than plenty for a small batch of
          PCBA.
        </p>
  ...
  renderProbe() {
    return (
      <div>
        ...
        <p>
          The probe is used to measure the height of your substrate. Right before a print the V-One will probe an array
          of points to create a height map.
        </p>
        <p>
          During printing, the V-One software uses the map and makes micro adjustments to the height to keep a constant
          height.
        </p>
  ...
  renderClamps() {
    return (
      <div>
        ...
        <p>
          These aluminum clamps will hold your board down securely for either printing or paste dispensing. They have
          been designed with flexibility in mind, allowing you to mount a wide range of board sizes and thicknesses.
        </p>
        <p>
          Clamping down the substrate is easy. The machine comes with a set of thumbscrews so no need to fiddle with
    ...
    return (
      <section id='v-one-box' className='box-wrapper'>
        ...
        <p className='pull-center'>
          The V-One comes with all the accessories and consumables you need to start building hardware faster.
        </p>
