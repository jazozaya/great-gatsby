        ...
        <section className="flex-row">
          ...
          <div className={style.description}>
            ...
            <p>
              ...
              magnetically mounted, so you do not need any special tools to swap them.
            </p>
            <p>
              During a print, the dispenser gear will rotate to apply and relieve pressure to accurately control the ink flow. With the
              click of a few buttons you can be printing 8 mil (200 micron) traces, but don't worry the software will guide you every step
              of the way.
            </p>
          </div>
        </section>
        ...
        <section className="flex-row reverse-wrap">
          <div className={style.description}>
            ...
            <p>
              ...
              into account and makes micro adjustments to ensure a constant printing height of 100 microns.{" "}
            </p>
            <p>
              Since we do not need the substrate to be conductive, we can dispense on rigid materials like FR4, glass and ceramics, along
