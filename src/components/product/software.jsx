    ...
    return (
      <div className={style.feature}>
        ...
        <section>
          ...
          <Dots selected={this.state.imgIndex.toString()} total={SoftwareImages.length.toString()} callback={this.overrideSelection} />
        </section>
        <section className={`flex-row ${style.columnWrapper}`}>
          <div className="column">
            ...
            <div className={style.description}>
              ...
              <p>
                We've developed a unique approach to alignment. Just tell the software the location of 2 key features in your board and it
                takes care the rest.
              </p>
              <p>
                This alignment method allows you to create two layer boards with ease, or dispense paste on boards that already have
                components.
              </p>
            </div>
          </div>
          <div className="column">
            ...
            <div className={style.description}>
              ...
              <p>
                The software uses the height map to compensate for any inconsistencies and irregularities on the surface and makes micro
                adjustments in real time to ensure a perfect print.
              </p>
            </div>
          </div>
        </section>
