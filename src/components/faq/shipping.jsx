    ...
    return (
      <Template id={id} title={title} all={all}>
        <Question underline title="What is the cost to ship to my country?">
          ...
          <p>It costs <strong>$250 USD</strong> per printer to ship international (not all countries supported).</p>
          <p>For 3 or more printers, please contact <strong>sales@voltera.io</strong></p>
          
        </Question>
        <Question underline title="Can I use my own shipping account?">
          <p>We have worked closely with our fantastic shipping partners to get the best rates for your orders.</p>
        ...
        <Question underline title="How can I pay?">
          ...
          <p>If you want to pay with a bank transfer, please send your PO to <strong>sales@voltera.io</strong> and we'll provide you our banking details.</p>
        </Question>
        <Question title="Are taxes and duties included?">
          ...
          <p>Normally when the shipment reaches your country, our courier will contact you to arrange the payment of duties and taxes to clear customs.</p>
        </Question>
      </Template>
    );
    }
