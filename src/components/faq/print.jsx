    ...
    return (
      <Template id={id} title={title} all={all}>
          ...
          <Question underline title="Does the ink deteriorate over time?">
            <p>We've tested our printed PCBs under 100mA load for 4 months in ambient, high-temperature (60°C) and low-temperature (5°C) environments, with no detectable change in performance.</p>
        </Question>
          <Question underline title="How does this ink compare to copper?">
            <p>The bulk resistivity of our ink is 9.5E-7 Ohms.m and the sheet resistance under typical conditions is 12 mOhms/sq.  It is among the best conductive inks on the market and while it is not as conductive as copper, it is capable of handling almost all digital and analog applications.</p>
          </Question>
