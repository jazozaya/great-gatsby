      ...
      <Template title={title} all={all}>
        <Collapse>
          ...
          <Panel header="Are there frequency or current limitations?">
            <p>An 8 month research partnership with the University of Alberta demonstrated the ink will perform just as good as standard copper up to 5 GHz!</p>
          ...
          <Panel header="How does this ink compare to copper?">
            The bulk resistivity of our ink is 9.5E-7 Ohms.m and the sheet resistance under typical conditions is 12 mOhms/sq.  It is among the best conductive ink on the market and while it is not as conductive as copper it is capable of handling most digital and analog applications.
          </Panel>
