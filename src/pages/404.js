    ...
    return (
      <Layout pathname={this.props.location.pathname}>
        <section className='not-found'>
          ...
          <p>
            We recently updated our website and it's possible we broke some things along the way. Please let us know
            what you are looking for by emailing <strong>support@voltera.io</strong>.
          </p>
        </section>
      </Layout>
    );
