...
const SoftwareImages = [
  '/assets/software/software-home.jpg',
  '/assets/software/software-outline.jpg',
  '/assets/software/software-priming.jpg',
  '/assets/software/software-printing.jpg',
  '/assets/software/software-locate-pad.jpg',
  '/assets/software/software-locate-pad-2.jpg'
      ...
      <div className="benefit-wrapper">
        <div className="benefit">
          ...
          <YouTube
            width="500"
            videoId="3oCkXdwWpUY"
            url="/assets/software/software-home-video.jpg"
          />
        </div>
